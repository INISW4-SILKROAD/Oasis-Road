...
data_root = 'C:/Users/SeoBS/mmdetection/custom/'
img_norm_cfg = dict(
...
data = dict(
    ...
    train=dict(
        type='CocoDataset',
        ann_file='C:/Users/SeoBS/mmdetection/custom/annotations/train4.json',
        img_prefix='C:/Users/SeoBS/mmdetection/custom/fabric/',
        pipeline=[
            dict(type='LoadImageFromFile'),
            dict(type='LoadAnnotations', with_bbox=True),
            dict(type='RandomFlip', flip_ratio=0.5),
    ...
    val=dict(
        type='CocoDataset',
        ann_file='C:/Users/SeoBS/mmdetection/custom/annotations/val4.json',
        img_prefix='C:/Users/SeoBS/mmdetection/custom/fabric/',
        pipeline=[
            dict(type='LoadImageFromFile'),
            dict(
...
log_level = 'INFO'
load_from = 'C:/Users/SeoBS/Co-DETR-main/logs/custom_swin_s/latest.pth'
resume_from = None
